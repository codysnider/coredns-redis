...
func (redis *Redis) LoadZones() {
	...
	*/
	for {
		reply, err = conn.Do("SCAN", cursor, "MATCH", matchPattern, "COUNT", "1000")
		if err != nil {
			return
		}

		// the updated cursor is byte encoded in index 0
		...
		// keys are []byte encoded starting in index 1, however redigo encodes them
		// as []interface{}
